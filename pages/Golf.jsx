...
function GolfPage({ onNav }) {
  ...
  const golfTiers = [
    ...
    { name: 'Visiting', tag: 'Non-Resident', body: 'Created for those who spend only part of the year in Palm Beach. Visiting Membership offers access to golf, practice facilities, and club amenities tailored to a seasonal lifestyle.', audience: 'Limited memberships available.' },

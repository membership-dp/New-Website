...
function GolfPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    body: ["Designed for purposeful practice and measurable improvement, the Club's training grounds include a 315-yard driving range, a two-acre short game complex, multiple practice greens, and a 12,000-square-foot putting surface.", 'Eight varieties of premium range balls allow members to refine distance control, trajectory, and feel in a setting built to support every aspect of the game.'],
    ...
    body: ["Instruction at Dutchman's Pipe is led by nationally recognized professionals, including Golf Magazine Top 100 instructors. Through private coaching, playing lessons, clinics, and performance-based training, members benefit from a comprehensive approach that blends technical expertise, biomechanics, and on-course strategy.", 'A strong commitment to player development extends across the membership, with dedicated programming for women, men, and juniors. From weekly Ladies Clinics to competitive member events, opportunities to learn, improve, and engage are woven into the Club experience year-round.'],

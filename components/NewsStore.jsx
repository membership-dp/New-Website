...
const DP_NEWS_DEFAULTS = {
  ...
  articles: [
    ...
    { img: 'assets/course-fountain-aerial.jpg', tag: 'AOL', date: 'Aug 2026', title: 'Rare golf access can open doors for golf’s next generation.', excerpt: '', url: 'https://www.aol.com/articles/rare-golf-access-open-doors-005225000.html?guccounter=1' },
    ...
    { img: 'assets/clubhouse-tacos.jpg', tag: 'GOLF', date: 'Jun 2026', title: 'Clubhouse eats.', excerpt: '', url: 'https://golf.com/lifestyle/food/elevate-hot-dog-tips-michelin-starred-chef/' },
    ...
    { img: 'assets/jet-arrival.jpg', tag: 'Golf Pass', date: 'Nov 2025', title: 'The amenities arms race.', excerpt: '', url: 'https://www.golfpass.com/travel-advisor/articles/upscale-private-golf-club-resort-amenities' },
    ...
    { img: 'assets/downtown-plaza.jpg', tag: 'New York Post', date: 'Mar 2025', title: "West Palm Beach's luxury growth — Dutchman's Pipe spotlight.", excerpt: '', url: '' },
    ...
    { img: 'assets/course-golden-hour.jpg', tag: 'Score Golf Magazine', date: 'Mar 2025', title: "A Dutchman's Pipe mention timed to the Cognizant Classic.", excerpt: '', url: '' },
  ],
};
...
const DP_NEWS_IMAGES = [
  ...
  'assets/course-fountain-aerial.jpg', 'assets/clubhouse-tacos.jpg',
  'assets/course-golden-hour.jpg', 'assets/jet-arrival.jpg',
  'assets/downtown-plaza.jpg',
];
